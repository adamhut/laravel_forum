...
<head>
  ...
  <link rel="stylesheet" href="/wesbos/assets/responsive-START.css">
...
<body>
  ...
  <script>
      ...
      function toggleNav({target}){
          console.log(target);
        const  expended = target.getAttribute('aria-expended') === 'true' || false;
        navButton.setAttribute('aria-expended',!expended);
      }
